...
# Startup lists
INNOVATION_CENTRE_STARTUPS = ["Aion Health Solutions", "Differr", "Navmarg", "Openzo", "Kraftr", "Project Mind Matters", "Instrumus", "Ripple Technologies", "Socyo Ischor & Vennbrd", "UpEase", "Bixel Studios", "Rial", "Brainso", "Thapy", "Go Perch"]
